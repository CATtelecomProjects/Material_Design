...
<title>Full-Width Page - Material</title>
...
<header class="header">
  ...
  <a class="header-logo" href="index.html"><strong>ระบบสารสนเทศทางธุรกิจ (BIS)</strong></a>
  <ul class="nav nav-list pull-right">
    <li> <a data-toggle="menu" href="#menu"> <span class="access-hide">John Smith</span> <span class="avatar avatar-sm"><img alt="alt text for John Smith avatar" src="images/users/avatar-001.jpg"></span> </a> </li>
  </ul>
</header>
<nav class="menu menu-right" id="menu">
  <div class="menu-scroll">
    <div class="menu-wrap">
      <div class="menu-content"> <a class="menu-logo" href="index.html">Material</a>
        <ul class="nav">
        ...
        <ul class="nav">
          ...
          <li> <a href="ui-form.html">Form Elements</a> <span class="menu-collapse-toggle collapsed" data-target="#form-elements" data-toggle="collapse"><i class="icon menu-collapse-toggle-close">close</i><i class="icon menu-collapse-toggle-default">add</i></span>
            <ul class="menu-collapse collapse" id="form-elements">
              <li> <a href="ui-form-adv.html">Form Elements <small>(materialised)</small></a> </li>
            </ul>
          </li>
        ...
        <hr>
        <ul class="nav">
          <li class="active"> <a href="page-affix.html">Full-Width Page (with fixed LHC/RHC)</a> </li>
          <li> <a href="page-palette.html">Page Palettes</a> <span class="menu-collapse-toggle collapsed" data-target="#page-palettes" data-toggle="collapse"><i class="icon menu-collapse-toggle-close">close</i><i class="icon menu-collapse-toggle-default">add</i></span>
  ...
  <div class="menu-scroll">
    <div class="menu-wrap">
      <div class="menu-top">
        ...
        <div class="menu-top-info"> <a class="menu-top-user" href="javascript:void(0)"><span class="avatar pull-left"><img alt="alt text for John Smith avatar" src="images/users/avatar-001.jpg"></span>John Smith</a> </div>
        <div class="menu-top-info-sub"> <small>Some additional information about John Smith</small> </div>
      </div>
...
<div class="content">
  ...
  <div class="content-heading"> 
    <!--<img src="http://www.eafm-indonesia.net/public/images/layout/header.png" width="100%" height="300px">-->
    <div class="container container-full text-center">
      <div class="collapsible-region" id="collapsible-region-header" >
        <div class="content">
          <div class="col-md-3 text-right">
            <p>&nbsp;</p>
            <i class="fa fa-chevron-left fa-3x" id="pre_header_content"></i> </div>
          <div class="col-md-6">
            <div class="col-md-12 card-alt" id="splash_news">
              <p class="active"><i class="fa fa-quote-left fa-2x"></i> Pellentesque sed gravida mi. Nam mollis sem ac mollis posuere. Curabitur viverra ultrices velit, vel feugiat dolor ullamcorper at. In nec pulvinar felis, ac faucibus purus. Quisque vehicula tincidunt suscipit. Aenean tincidunt ultricies sapien vel sagittis. Sed risus neque, tristique vel lorem dignissim, rhoncus ultricies arcu. Morbi fringilla massa ipsum. Mauris vel tellus dapibus, lacinia ipsum sit amet, pharetra ipsum. In hac habitasse platea dictumst.<i class="fa fa-quote-right fa-2x"></i> </p>
              <p class="margin-no-top"><a class="btn waves-button btn-sm waves-effect waves-light" href="#">Read more...</a></p>
            </div>
          </div>
          <div class="col-md-3 content-fix text-left">
            <p>&nbsp;</p>
            <i class="fa fa-chevron-right fa-3x" id="next_header_content"></i> </div>
        </div>
      </div>
    </div>
    <div id="toggle_header" class="text-center"> <span  data-toggle="collapsed" href="#collapsible-region-header"><span class="collapsed-show"><i class="fa fa-angle-double-down fa-2x"></i></span><span class="collapsed-hide"><i class="fa fa-angle-double-up fa-2x"></i></span></span> </div>
  </div>
    <!-- Header Content -->
...
<div class="tile-wrap tile-wrap-animation tile-hover">
  <div class="tile">
    <div class="tile-inner">
      <p class="margin-no-top" align="center"><img src="./images/login.png" alt="image key"> <br>
        <a class="btn btn-green waves-button waves-effect waves-light" data-toggle="modal" href="#modal-login"><i class="fa fa-sign-in"> เข้าสู่ระบบ</i></a> </p>
    </div>
  </div>
</div>
<div class="tile-wrap tile-wrap-animation tile-hover">
  <div class="tile">
    <div class="tile-inner">
      <p class="margin-no-top" align="center"><img src="./images/login.png" align="img key"> <br>
        <a class="btn btn-orange waves-button waves-effect waves-light" data-toggle="modal" href="#modal-logout"><i class="fa fa-sign-out"> ออกจากระบบ</i></a></p>
    </div>
  </div>
  <div class="tile tile-menu">
    <div class="pull-left tile-side">
      <div class="avatar avatar-blue avatar-inline"> <i class="fa fa-2x fa-line-chart"></i> </div>
    </div>
    <div class="tile-inner"> <span><strong><u>CAT-KPIs</u></strong> :  ระบบประเมินผลการดำเนินงานตาม KPIs </span> </div>
  </div>
  <div class="tile tile-menu">
    <div class="pull-left tile-side">
      <div class="avatar avatar-green avatar-inline"> <i class="fa fa-2x fa-bar-chart"></i> </div>
    </div>
    <div class="tile-inner"> <span><strong><u>BI Report</u></strong> : 
      รายงานระบบคลังข้อมูล/เหมืองข้อมูล
      (Data Warehouse/Data Mining)</span> </div>
  </div>
  <div class="tile tile-menu">
    <div class="pull-left tile-side">
      <div class="avatar avatar-orange avatar-inline"> <i class="fa fa-2x fa-pie-chart"></i> </div>
    </div>
    <div class="tile-inner"> <span><strong><u>DW-Web Report Studio</u></strong> : 
      ดู/แก้ไขรายงานระบบคลังข้อมูล/เหมืองข้อมูล
      (Data Warehouse/Data Mining)</span> </div>
  </div>
  <div class="tile tile-menu">
    <div class="pull-left tile-side">
      <div class="avatar avatar-blue avatar-inline"> <i class="fa fa-2x fa-file-text"></i> </div>
    </div>
    <div class="tile-inner"> <span><strong><u>Summary of Invoices</u></strong> : ระบบรายงานสรุปยอดใบแจ้งค่าใช้บริการ</span> </div>
  </div>
  <div class="tile tile-menu">
    <div class="pull-left tile-side">
      <div class="avatar avatar-green avatar-inline"> <i class="fa fa-2x fa-wifi"></i> </div>
    </div>
    <div class="tile-inner"><span><strong><u>Spectrum Management</u></strong> : 
      ระบบบริหารความถี่วิทยุโทรคมนาคม</span> </div>
  </div>
  <div class="tile tile-menu">
    <div class="pull-left tile-side">
      <div class="avatar avatar-orange avatar-inline"> <i class="fa fa-2x fa-desktop"></i> </div>
    </div>
    <div class="tile-inner"> <span><strong><u>My Reports</u></strong> : 
      ระบบรายงาน my </span> </div>
  </div>
  <div class="tile tile-menu">
    <div class="pull-left tile-side">
      <div class="avatar avatar-purple avatar-inline"> <i class="fa fa-2x fa-users"></i> </div>
    </div>
    <div class="tile-inner"> <span><strong><u>BIS User Management</u></strong> : 
      ระบบจัดการผู้ใช้งาน BIS 
      สามารถ เพิ่ม ลบ แก้ไข กำหนดสิทธิ์,ค้นหาผู้ใช้งาน, Logs การใช้งานต่างๆ</span> </div>
  </div>
</div>
<div class="tile-wrap tile-wrap-animation">
  <div class="tile">
    <div class="tile-inner">
      <p align="center"> <img src="https://bis.cattelecom.com/images/img_counter/gif/5.gif" align="absmiddle"><img src="https://bis.cattelecom.com/images/img_counter/gif/1.gif" align="absmiddle"><img src="https://bis.cattelecom.com/images/img_counter/gif/6.gif" align="absmiddle"><img src="https://bis.cattelecom.com/images/img_counter/gif/6.gif" align="absmiddle"><img src="https://bis.cattelecom.com/images/img_counter/gif/5.gif" align="absmiddle"><br>
        (เริ่มนับเมื่อ 4 ก.ค. 2548) </p>
      <table border="0" width="100%">
        <tbody>
          <tr>
            <td align="center"><img src="https://bis.cattelecom.com/images/system/useronline.jpg" botder="0" align="absmiddle"> <strong>สถิติผู้ใช้งาน</strong></td>
          </tr>
          <tr>
            <td>• สถิติวันนี้ : <strong>26</strong> คน</td>
          </tr>
          <tr>
            <td>• สถิติเมื่อวาน : <strong>20</strong> คน</td>
          </tr>
          <tr>
            <td>• สถิติเดือนนี้ : <strong>302</strong> คน</td>
          </tr>
          <tr>
            <td>• สถิติเดือนที่แล้ว : <strong>287</strong> คน</td>
          </tr>
          <tr>
            <td>• สถิติปีนี้ : <strong>2,538</strong> คน</td>
          </tr>
          <tr>
            <td>• สถิติปีที่แล้ว : <strong>5,619</strong> คน</td>
          </tr>
          <tr>
            <td align="center">(นับจากการ Login ของผู้ใช้งาน)</td>
          </tr>
        </tbody>
      </table>
    </div>
...
<div class="fbtn-container">
  <div class="fbtn-inner"> <a class="fbtn fbtn-red fbtn-lg" data-toggle="dropdown"><span class="fbtn-text">Links</span><span class="fbtn-ori icon">add</span><span class="fbtn-sub icon">close</span></a>
    <div class="fbtn-dropdown"> <a class="fbtn" href="https://github.com/Daemonite/material" target="_blank"><span class="fbtn-text">Fork me on GitHub</span><span class="fa fa-github"></span></a> <a class="fbtn fbtn-blue" href="https://twitter.com/daemonites" target="_blank"><span class="fbtn-text">Follow Daemon on Twitter</span><span class="fa fa-twitter"></span></a> <a class="fbtn fbtn-alt" href="http://www.daemon.com.au/" target="_blank"><span class="fbtn-text">Visit Daemon Website</span><span class="icon">link</span></a> </div>
  </div>
</div>
